...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Omer Khan Jadoon Personal</title>
		...
		<div class="container">
			<div class="row fullscreen d-flex align-items-center">
				<div class="banner-content col-lg-6 col-md-12 justify-content-center ">
					...
					<h1 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.7s">Omer Khan Jadoon</h1>
				...
				<div class="banner-img col-lg-6 col-md-6 align-self-end">
					<img class="img-fluid" src="img/banner-im.png" alt="omer">
				</div>
			</div>
		</div>
	</section>
